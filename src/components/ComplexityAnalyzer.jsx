    ...
    return (
        ...
        >
            ...
            <AnimatePresence mode="wait">
                {result && (
                    <motion.div className="space-y-6" variants={resultVariants} initial="hidden" animate="visible" exit="exit">
                        {result.error ? (
                            <motion.div
                                ...
                                <motion.div className="space-y-6" variants={containerVariants}>
                                    ...
                                    >
                                        <div className="flex items-center gap-3 mb-4">
                                            <div className="w-8 h-8 bg-gradient-to-r from-indigo-500 to-fuchsia-500 rounded-full flex items-center justify-center">
                                                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                    <path
                                                        fillRule="evenodd"
                                        ...
                                        >
                                            ...
                                            <motion.div className="space-y-3" variants={containerVariants}>
                                                {[
                                                    ...
                                                    <motion.div
                                                        key={item.label}
                                                        className="flex items-center justify-between p-3 bg-zinc-50 rounded-lg hover:bg-zinc-100 transition-colors duration-200"
