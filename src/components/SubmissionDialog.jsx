...
const SubmissionDialog = ({ id, isOpen, onClose, title, content }) => {
    ...
    return (
        <div className="fixed submission-dialog inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-4">
            <div
                className={`
            ...
            >
                <div className="flex items-center justify-between p-6 border-b border-gray-700 flex-shrink-0 rounded-t-xl">
                    ...
                    <Button
                        ...
                        size="icon"
                        onClick={onClose}
                        className="text-gray-400 hover:text-white hover:bg-red-500/20 focus-ring rounded-lg"
                    >
                        <X className="w-5 h-5" />
                    </Button>
                </div>
                    ...
                    <div className="p-6 space-y-6">
                        {isLoadingQuestion ? (
                            ...
                            questionData?.question && (
                                <Card className="modern-card animate-slide-up rounded-lg">
                        ...
                        {isLoadingSubmission ? (
                            ...
                            <Card className="modern-card animate-slide-up rounded-lg">
                                ...
                                <CardContent>
                                    <div className="bg-gray-900 rounded-lg p-4 border border-gray-700 max-h-48 overflow-y-auto scrollbar-thin scrollbar-track-gray-800 scrollbar-thumb-gray-600">
                        ...
                        <Card className="modern-card animate-slide-up rounded-lg">
                            ...
                            <CardContent className="space-y-6">
                                <div className="space-y-3">
                                    ...
                                    {isLoadingRepos ? (
                                        <div className="modern-input focus-ring h-12 rounded-lg flex items-center px-3">
                                        ...
                                        <Select value={selectedRepo} onValueChange={setSelectedRepo}>
                                            <SelectTrigger className="modern-input focus-ring h-12 rounded-lg">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-3">
                                        ...
                                        <Input
                                            ...
                                            className="modern-input focus-ring h-12 rounded-lg"
                                        />
                ...
                <div className="flex items-center justify-between p-6 border-t border-gray-700 flex-shrink-0 rounded-b-xl">
                    <div className="flex items-center gap-3">
                        {selectedRepo ? (
                            ...
                            <div className="flex items-center gap-2 px-3 py-2 bg-yellow-500/20 border border-yellow-500/40 rounded-lg">
                    ...
                    <div className="flex gap-3">
                        <Button
                            variant="outline"
                            onClick={onClose}
                            className="modern-button-secondary h-12 px-6 focus-ring rounded-lg"
                        >
                            Cancel
                        </Button>
                        <Button
                            ...
                            className="modern-button-primary h-12 px-6 focus-ring rounded-lg"
                        >
                            {isSubmitting ? (
                                <>
